...
var BufferWriter = cicocore.encoding.BufferWriter;
var BufferReader = cicocore.encoding.BufferReader;
...
describe("Output", function() {
  ...
  it("#toObject roundtrip will handle an invalid (null) script", function() {
    ...
    var br = new cicocore.encoding.BufferReader(invalidOutputScript);
