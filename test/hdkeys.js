...
var HDPublicKey = cicocore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = cicocore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(cicocore.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(cicocore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      cicocore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = cicocore.PublicKey.fromPoint;
      cicocore.PublicKey.fromPoint = function() {
        cicocore.PublicKey.fromPoint = unstubbed;
