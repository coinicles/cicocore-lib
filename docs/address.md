...
The errors are listed in the generated file in the [errors folder](https://github.com/coinicles/cicocore/tree/master/packages/cicocore-lib/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/coinicles/cicocore/tree/master/packages/cicocore-lib/lib/errors/spec.js).
