...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'https://cicocore.io/api/lib/transaction#serialization-checks';
 ...
 * and a slightly fancier format recognized by cicocore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a cicocore Address object. The
 * same is true for `script`, which can be a string or a cicocore Script.
 *
